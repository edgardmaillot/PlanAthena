// Emplacement: PlanAthenaTests/Utilities/DependanceBuilderTests.cs
...
namespace PlanAthenaTests.Utilities
{
    ...
    public class DependanceBuilderTests
    {
        ...
        public void Setup()
        {
            ...
            // On instancie TaskManagerService qui est maintenant central
            // On lui passe des mocks/nulls car on ne teste pas sa logique interne ici
            ...
            // On instancie les autres services avec leurs nouveaux constructeurs et delegates
            _projetService = new ProjetService(_idGenerator);
            _ressourceService = new RessourceService(_idGenerator);

            // DependanceBuilder a maintenant besoin de TaskManagerService
            _dependanceBuilder = new DependanceBuilder(_ressourceService);
        }

        // Helper CORRIGÉ pour charger les données de test dans les bons services
        private void ChargerDonneesDeTest(List<Metier> metiers, List<Tache> taches)
        {
            ...
            var projetData = new ProjetData { Lots = lots }; // Ne contient plus les tâches
            _projetService.ChargerProjet(projetData);
            _taskManagerService.ChargerTaches(taches); // Les tâches sont chargées ici
        }
        ...
        public void ObtenirDependances_CycleExistant_NeDoitPasProposerDependanceInverse()
        {
            ...
            var tache1 = _taskManagerService.ObtenirTache("L001_B001_T001");
            var contexte = _taskManagerService.ObtenirToutesLesTaches();
        ...
        public void ObtenirDependances_SuggestionMetier_DoitMarquerCommeSuggeree()
        {
            ...
            var tachePlomberie = _taskManagerService.ObtenirTache("L001_B001_T002");
        ...
        public void ObtenirDependances_DependanceStricte_DoitMarquerCommeStricte()
        {
            ...
            ChargerDonneesDeTest(new List<Metier>(), taches);
            var tache2 = _taskManagerService.ObtenirTache("L001_B001_T002");
