...
namespace PlanAthena.View
{
    partial class TaskManagerView
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.creationToolboxView1 = new PlanAthena.View.CreationToolboxView();
            this.splitContainerCentreDroit = new Krypton.Toolkit.KryptonSplitContainer();
            this.pertDiagramControl1 = new PlanAthena.Controls.PertDiagramControl();
            this.kryptonSplitContainerRight = new Krypton.Toolkit.KryptonSplitContainer();
            this.lotSelectionView1 = new PlanAthena.View.LotSelectionView();
            this.tacheDetailView1 = new PlanAthena.View.TacheDetailView();
        ...
        private Controls.PertDiagramControl pertDiagramControl1;
